    ...
    return (
        <Segment clearing>
            <Form onSubmit={handelSubmit} autoComplete="off">
                ...
                <Form.Input placeholder='Date' name="date" value={activity.date} onChange={handelInputChange} />
                ...
                <Button type='submit' content="Subimt" floated='right' positive onChange={handelInputChange} />
